...
namespace EditorImagenes_Proyecto1
{
    class SequentialImageFilter
    {
        ...
        public static void grayScale(Bitmap bitmap, string imagePath)
        {
            //get image dimension
        ...
        //brigth **
        public static void brigthness(Bitmap bitmap)
        {
        }
        //texture **
        public static void texture(Bitmap bitmap)
        {
        }
        ...
        /// </summary>
        public static void sepiaFunction(Bitmap bmp, string imagePath)
        {
            //get image dimension
            int width = bitmap.Width;
            int height = bitmap.Height;
        ...
        /// Function where we will apply the sepia filter to the loaded image
        /// </summary>
        public static void sepiaFunction(string imagePath)
        {
            //read image
